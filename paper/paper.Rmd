...
overlap. For example, assuming the group mean is 3.5 on the 1 to 7 scale, `overlap_circle()` will draw a 25% overlap from interpolation: 
...
Similarly for univariate outliers using median absolute deviations from the median [MAD, 
@leys2013outliers].
...
```{r nice_var_plot, fig.width=8, fig.height=7}
