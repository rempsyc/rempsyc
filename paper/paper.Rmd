...
knitr::include_graphics("paper_files/figure-markdown_strict/nice_table-1.png")
```
...
```{r overlap_circle, fig.width=7, fig.height=7, out.width="30%"}
overlap_circle(3.5)
```
...
```{r nice_normality, fig.width=16, fig.height=7, out.width="80%"}
...
```{r plot_outliers, fig.width=8, fig.height=7, out.width="70%"}
