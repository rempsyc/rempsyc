...
Should you wish to specifically install all suggested dependencies at
once (you can view the full list by clicking on the CRAN badge on this
page), you can run the following (be warned that this may take a long
time, as some of the suggested packages are only used in the vignettes
or examples):
...
[Nice APA tables](#nice-apa-tables)

[T-tests, planned contrasts, regressions, moderations, simple
slopes](#t-tests-planned-contrasts-regressions-moderations-simple-slopes)
...
or saved to Word with the
[`flextable::save_as_docx`](https://davidgohel.github.io/flextable/reference/save_as_docx.html)
function, and are `flextable` objects, and can be modified as such. The
function also integrates with objects from the `broom` and `report`
packages. Full tutorial:
<https://rempsyc.remi-theriault.com/articles/table>
...
![](reference/figures/README-nice_t_test-1.png)
...
![](reference/figures/README-nice_contrasts-1.png)
...
![](reference/figures/README-nice_mod-1.png)
...
![](reference/figures/README-nice_lm-1.png)
...
![](reference/figures/README-nice_slopes-1.png)
...
![](reference/figures/README-nice_lm_slopes-1.png)

Full tutorial: <https://rempsyc.remi-theriault.com/articles/moderation>

## Visualization

All plots can be saved with the
[`ggplot2::ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.html)
function. They are `ggplot2` objects so can be modified as such.
...
![](reference/figures/README-nice_violin-1.png)
...
![](reference/figures/README-nice_scatter-1.png)
...
![](reference/figures/README-nice_scatter2-1.png)
...
![](reference/figures/README-plot_means_over_time-1.png)
...
![](reference/figures/README-overlap_circle-1.png)
...
![](reference/figures/README-overlap_circle-2.png)
...
![](reference/figures/cormatrix.png)![](reference/figures/cormatrix2.png)
...
![](reference/figures/assumptions_table.png)
...
![](reference/figures/README-nice_normality-1.png)
...
![](reference/figures/README-plot_outliers-1.png)
...
![](reference/figures/README-plot_outliers-2.png)
...
![](reference/figures/README-nice_varplot-1.png)
