...
```{r warning = FALSE, message = FALSE, fig.width=8, fig.height=7, out.width="70%"}
...
Thank you for your support. You can support me and this package here: https://remi-theriault.com/donate/
