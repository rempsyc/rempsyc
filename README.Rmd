...
[![packageversion](https://img.shields.io/badge/Package%20version-`r version`-orange.svg?style=flat-square)](commits/main)
...
```{r example2, warning = FALSE, message = FALSE, fig.width=8, fig.height=7, out.width="60%" }
# Save to word
