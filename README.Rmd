...
```{r README-14, warning = FALSE, message = FALSE, fig.width=8, fig.height=7, out.width="60%"}
...
```{r README-16, warning = FALSE, message = FALSE}
...
```{r README-17, warning = FALSE, message = FALSE, fig.width=7, fig.height=7, out.width="60%"}
...
```{r README-19, warning = FALSE, message = FALSE}
...
```{r README-20, warning = FALSE, message = FALSE, fig.width=8, fig.height=7, out.width="80%"}
...
```{r README-22, warning = FALSE, message = FALSE}
...
```{r README-23, warning = FALSE, message = FALSE, fig.width=8, fig.height=7, out.width="70%"}
