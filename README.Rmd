...
```{r nice_qq, warning = FALSE, message = FALSE, fig.width=8, fig.height=7, out.width="80%"}
...
```{r nice_density, warning = FALSE, message = FALSE, fig.width=8, fig.height=7, out.width="80%"}
