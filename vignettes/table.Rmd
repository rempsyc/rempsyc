...
Another colleague asked, whether it was possible to use the multilevel headings, while still benefiting from the regular automatic formatting of the p-values, confidence intervals, etc. That wasa a challenging task to implement, but I think I've got something that should *mostly* work. Demo:
