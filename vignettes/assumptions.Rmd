...
![](https://rempsyc.github.io/rempsyc/articles/images/blog_assumptions/assumptions1.png)
...
assumptions.table <- do.call("rbind", lapply(models.list, nice_assumptions, interpretation = FALSE))
```
...
![](https://rempsyc.github.io/rempsyc/articles/images/blog_assumptions/assumptions2.png)

Or alternatively with the [nice_table() function](https://remi-theriault.com/blog_table)
...
![](https://rempsyc.github.io/rempsyc/articles/images/blog_assumptions/var1.png)
...
Use the Viewer for better results (or export it to Word using my [nice_table() function](https://remi-theriault.com/blog_table))

```{r, eval = FALSE}
View(var.table)
```

![](https://rempsyc.github.io/rempsyc/articles/images/blog_assumptions/var2.png)
