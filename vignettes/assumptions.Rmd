...
To check outliers for categorical predictors, we can check for each group whether any observations is greater than 3 units (either standard deviations, SDs, or median absolute deviations, MADs).
