...
![](blog images/blog_randomize/step2.png)

3. Select columns A to H (or whichever columns you have).

![](blog images/blog_randomize/step3.png)
...
![](blog images/blog_randomize/step4.png)

7. Paste selection (press CTR+V).
8. Select whole table.

![](blog images/blog_randomize/step5.png)
...
![](blog images/blog_randomize/step6.png)
    
10. Center all text by going to the table 'Layout' tab, Alignment section, then clicking on the *Align Center* button.
    
![](blog images/blog_randomize/step7.png)
    
11. Next ajust the columns width to fit your page (especially the "Notes" column, which should be wider)

![](blog images/blog_randomize/step8.png)
...
![](blog images/blog_randomize/step9.png)
...
![](blog images/blog_randomize/step12.png)
...
![](blog images/blog_randomize/step13.png)
