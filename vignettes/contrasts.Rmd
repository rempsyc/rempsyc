...
### Make it publication-ready using [`nice_table()`](https://remi-theriault.com/blog_table).
...
### Make a violin plot comparing groups through [`nice_violin()`](https://remi-theriault.com/blog_violin).
...
### Make violin plots comparing groups through [`nice_violin`](https://remi-theriault.com/blog_violin).
...
*Updated 2022-06-07 (Updated theme)*
