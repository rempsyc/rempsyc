...
#'
#' @seealso
#' Checking for moderation before checking simple slopes: \code{\link{nice_lm}}, \code{\link{nice_mod}}, \code{\link{nice_slopes}}. Tutorial: https://remi-theriault.com/blog_moderation
#'
